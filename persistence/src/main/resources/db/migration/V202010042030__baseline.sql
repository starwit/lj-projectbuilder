...
CREATE TABLE CODETEMPLATE_APP
  (
     CODETEMPLATE_ID BIGINT NOT NULL,
     APP_ID      BIGINT NOT NULL,
     PRIMARY KEY (CODETEMPLATE_ID, APP_ID)
  );
...
ALTER TABLE CODETEMPLATE_APP
  ADD CONSTRAINT FK_CODETEMPLATE_APP FOREIGN KEY (APP_ID) REFERENCES
  APP (ID);
