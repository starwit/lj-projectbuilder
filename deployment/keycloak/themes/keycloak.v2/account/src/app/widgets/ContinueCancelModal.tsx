...
export class ContinueCancelModal extends React.Component<ContinueCancelModalProps, ContinueCancelModalState> {
    ...
    public render(): React.ReactNode {
        ...
        return (
                <React.Fragment>
                    {!this.props.render &&
                            <Button id={this.props.buttonId} variant={this.props.buttonVariant}
                    ...
                    <Modal
                            ...
                            actions={[
                                <Button id='modal-confirm' key="confirm" variant="primary"
                                        onClick={this.handleContinue}>
                                    <Msg msgKey={this.props.modalContinueButtonLabel!}/>
                                </Button>,
                                <Button id='modal-cancel' key="cancel" variant="secondary"
