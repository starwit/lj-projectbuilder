...
import {EditAltIcon, Remove2Icon, RepositoryIcon, ShareAltIcon} from '@patternfly/react-icons';
...
import {AbstractResourcesTable, ResourcesTableProps, ResourcesTableState} from './AbstractResourceTable';
                    ...
                    {this.props.resources.data.map((resource: Resource, row: number) => (
                            <DataListItem key={'resource-' + row} aria-labelledby={resource.name}
                                ...
                                <DataListItemRow>
                                    ...
                                    <DataListItemCells
                                            dataListCells={[
                                                <DataListCell id={'resourceName-' + row} key={'resourceName-' + row}
                                                              width={5}>
                                                    <Msg msgKey={resource.name}/>
                                                </DataListCell>,
                                                <DataListCell id={'resourceClient-' + row} key={'resourceClient-' + row}
                                                              width={5}>
                                                    <a href={resource.client.baseUrl}>{this.getClientName(resource.client)}</a>
                                                </DataListCell>,
                                                <DataListCell id={'resourceRequests-' + row}
                                                              key={'permissionRequests-' + row} width={5}>
                                        ...
                                        <Dropdown
                                                ...
                                                dropdownItems={[
                                                    ...
                                                    >
                                                        {
                                                            (toggle: () => void) => (
                                                                    <DropdownItem id={'mob-share-' + row}
                                                                                  key="mob-share" onClick={toggle}>
                                ...
                                >
                                    <Level hasGutter>
                                        ...
                                        <LevelItem
                                                id={'shared-with-user-message-' + row}>{this.sharedWithUsersMessage(row)}</LevelItem>
                                        <LevelItem><span/></LevelItem>
                                    </Level>
                                </DataListContent>
                            </DataListItem>
