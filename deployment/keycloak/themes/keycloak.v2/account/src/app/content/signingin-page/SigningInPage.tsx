 ...
 */
class SigningInPage extends React.Component<SigningInPageProps,
        SigningInPageState> {
                            ...
                            <DataListItemRow key='no-credentials-list-item-row' className="pf-u-align-items-center">
                                <DataListItemCells
                                        dataListCells={[
                                            ...
                                            <EmptyState id={`${type}-not-set-up`} key={'no-credentials-cell-1'}
                    ...
                    userCredentialMetadatas.map(credentialMetadata => (
                            <>
                                {(credentialMetadata.infoMessage && !credentialMetadata.warningMessageTitle && !credentialMetadata.warningMessageDescription) &&
                                        <Alert variant="default" className="pf-u-mb-md" isInline isPlain
                                ...
                                {(credentialMetadata.warningMessageTitle && credentialMetadata.warningMessageDescription) &&
                                        <Alert variant="warning" className="pf-u-mb-md" isInline
    ...
    private credentialRowCells(credMetadata: CredMetadata, type: string): React.ReactNode[] {
        ...
        credRowCells.push(
                <DataListCell id={`${SigningInPage.credElementId(type, credential.id, 'label')}`}
                              key={'userLabel-' + credential.id} className="pf-u-max-width" style={maxWidth}>
