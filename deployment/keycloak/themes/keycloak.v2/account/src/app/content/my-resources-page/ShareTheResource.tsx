...
import {Permission, Resource, Scope} from './resource-model';
                ...
                <React.Fragment>
                    ...
                    <Modal
                            ...
                            actions={[
                                ...
                                <Button key="confirm" variant="primary" id="done" onClick={this.handleAddPermission}
                                ...
                                <Form>
                                    ...
                                    >
                                        <Gallery hasGutter>
                                            ...
                                            <GalleryItem>
                                                <Button key="add-user" variant="primary" id="add"
