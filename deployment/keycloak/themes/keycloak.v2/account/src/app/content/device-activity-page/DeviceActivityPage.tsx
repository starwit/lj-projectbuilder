...
import {DesktopIcon, MobileAltIcon, SyncAltIcon,} from '@patternfly/react-icons';
                ...
                >
                    <PageSection isFilled variant={PageSectionVariants.light}>
                        <Split hasGutter className="pf-u-mb-lg">
                            <SplitItem isFilled>
                                <div id="signedInDevicesTitle" className="pf-c-content"><Title headingLevel="h2"
                                                                                               size="xl"><Msg
                                        msgKey="signedInDevices"/></Title></div>
                            </SplitItem>
                            <SplitItem>
                                                            ...
                                                            <React.Fragment
                                                                ...
                                                                <DataListItemRow>
                                                                    <DataListContent
                                                                        ...
                                                                        <Grid className="signed-in-device-grid"
                                                                              hasGutter>
                                                                            <GridItem className="device-icon" span={1}
                                                                                      rowSpan={2}>
                                                                                <span>{this.findDeviceTypeIcon(session, device)}</span>
                                                                            </GridItem>
                                                                            <GridItem sm={8} md={9} span={10}>
                                                                                <span id={this.elementId('browser', session)}
                                                                                      className="pf-u-mr-md">{this.findOS(device)} {this.findOSVersion(device)} / {session.browser}</span>
                                                                                {session.current &&
                                                                                        <Label color="green"><Msg
                                                                                                msgKey="currentSession"/></Label>}
                                                                            </GridItem>
                                                                            <GridItem className="pf-u-text-align-right"
                                                                                      sm={3} md={2} span={1}>
                                                                                {!session.current &&
                                                                                        <ContinueCancelModal
