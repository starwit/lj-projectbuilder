                ...
                >
                    ...
                    />
                                ...
                                {this.state.applications.map((application: Application, appIndex: number) => {
                                    return (
                                            <DataListItem id={this.elementId("client-id", application)}
                                                ...
                                                <DataListItemRow className="pf-u-align-items-center">
                                                    ...
                                                    <DataListItemCells
                                                            ...
                                                            dataListCells={[
                                                                <DataListCell id={this.elementId('name', application)}
                                                                              width={2} key={'app-' + appIndex}>
                                                                    <Button className="pf-u-pl-0 title-case"
                                                                            component="a" variant="link"
                                                                ...
                                                                <DataListCell id={this.elementId('status', application)}
                                                                              width={2} key={'status-' + appIndex}>
                                                ...
                                                >
                                                    <DescriptionList>
                                                        ...
                                                        {application.consent &&
                                                                <React.Fragment>
                                                                    <DescriptionListGroup>
                                                                        <DescriptionListTerm>Has access
                                                                            to</DescriptionListTerm>
                                                                        {application.consent.grantedScopes.map((scope: GrantedScope, scopeIndex: number) => {
                                                                            return (
                                                                                    <React.Fragment
                                                                                            key={'scope-' + scopeIndex}>
                                                                                        <DescriptionListDescription><CheckIcon/> {scope.name}
                                                                                        </DescriptionListDescription>
                                                                                    </React.Fragment>
                                                                            )
                                                                        })}
                                                    ...
                                                    {(application.consent || application.offlineAccess) &&
                                                            <Grid hasGutter>
                                                                ...
                                                                <GridItem><InfoAltIcon/> {Msg.localize('infoMessage')}
                                                                </GridItem>
                                                            </Grid>
                                                    }
                                                </DataListContent>
