...
import {PaginatedResources, Permission, Resource, Scope} from './resource-model';
                ...
                <Tab id={title} eventKey={eventKey} title={Msg.localize(title)}>
                    <Stack hasGutter>
                        ...
                        <StackItem isFilled>
                            <Level hasGutter>
                                <LevelItem>
                                    <TextInput value={this.state.nameFilter} onChange={this.handleFilterRequest}
                                               id={'filter-' + title} type="text"
                                               placeholder={Msg.localize('filterByName')} iconVariant="search"/>
                                </LevelItem>
                            </Level>
                        </StackItem>
                        <StackItem isFilled>
        ...
        return (
                <ContentPage title="resources" onRefresh={this.fetchInitialResources.bind(this)}>
                    <PageSection variant={PageSectionVariants.light}>
                        ...
                        <Level hasGutter>
                            <LevelItem>
                                {this.hasPrevious() && <Button onClick={this.handlePreviousClick}>&lt;<Msg
                                        msgKey='previousPage'/></Button>}
                            </LevelItem>

                            <LevelItem>
                                {this.hasPrevious() &&
                                        <Button onClick={this.handleFirstPageClick}><Msg msgKey='firstPage'/></Button>}
                            </LevelItem>

                            <LevelItem>
                                {this.hasNext() &&
                                        <Button onClick={this.handleNextClick}><Msg msgKey='nextPage'/>&gt;</Button>}
                            </LevelItem>
                        </Level>
                    </PageSection>
                </ContentPage>
