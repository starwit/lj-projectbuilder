...
/**
 * Class for processing the whole app setup. A newly configured app is created
 * and can be used.
 *
...
public class AppSetupService implements Serializable {
     ...
     * - generate CRUD-Operations for the several layers (Database access, REST API
     * and frontend)
     *
    ...
    /**
     * Executes all functions needed to get template description from git repository
     * and updates template definitions in database.
     *
     * @param dto - configuration for app setup
     * @return
     * @throws NotificationException
