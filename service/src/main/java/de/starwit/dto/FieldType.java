...
public enum FieldType {
    String(new FieldValidateRulesType[] {
            FieldValidateRulesType.required,
            FieldValidateRulesType.minlength,
            FieldValidateRulesType.maxlength,
            FieldValidateRulesType.pattern,
            FieldValidateRulesType.unique
    }),
    Integer(new FieldValidateRulesType[] {
            FieldValidateRulesType.required,
            FieldValidateRulesType.min,
            FieldValidateRulesType.max,
            FieldValidateRulesType.unique
    }),
    Long(new FieldValidateRulesType[] {
            FieldValidateRulesType.required,
            FieldValidateRulesType.min,
            FieldValidateRulesType.max,
            FieldValidateRulesType.unique
    }),
    BigDecimal(new FieldValidateRulesType[] {
            FieldValidateRulesType.required,
            FieldValidateRulesType.min,
            FieldValidateRulesType.max,
            FieldValidateRulesType.unique
    ...
    Boolean(new FieldValidateRulesType[] {
            FieldValidateRulesType.required,
            FieldValidateRulesType.unique
    }),
