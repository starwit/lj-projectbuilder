    ...
    return (
        <Dialog open={!!entityId || (open && entity.isNewEntity)} maxWidth={"xl"} fullWidth>
            <DialogTitle className={entityEditorStyles.dialogHeaderBar}>
                ...
                <IconButton aria-label="close" onClick={prepareClose}>
                    <Close />
                </IconButton>
            </DialogTitle>
            <Container>
                ...
                <Box className={entityEditorStyles.tabBox}>
                    <Tabs value={value} onChange={handleTabChange} className={entityEditorStyles.tabHeader} aria-label="Entity property tabs">
