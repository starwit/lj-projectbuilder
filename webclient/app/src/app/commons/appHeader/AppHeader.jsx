    ...
    return (
        <>
            <AppBar
                position="fixed"
                color="inherit"
                className={appHeaderStyles.appBar}
            >
                <Toolbar className={appHeaderStyles.toolbar}>
                    <img
                        className={appHeaderStyles.menuLogoImg}
                        src={logo}
                        alt="Logo of lirejarp"
                    />
                    <div className={appHeaderStyles.spacer} />
                    <Button
                        color="secondary"
                        disableRipple
                        className={appHeaderStyles.linkButton}
                    ...
                    <Button
                        ...
                        disableRipple
                        className={appHeaderStyles.linkButton}
                        onClick={() => history.push("/apptemplates/all")}
                    >
