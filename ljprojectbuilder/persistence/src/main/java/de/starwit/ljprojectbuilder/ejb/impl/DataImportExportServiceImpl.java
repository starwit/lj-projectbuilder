...
import de.starwit.ljprojectbuilder.config.ProjectConfig;
import de.starwit.ljprojectbuilder.ejb.DataImportExportService;
		...
		try {
			...
			if (file.exists()) {
			    ...
			    while (tok.hasMoreTokens()) {
					...
					Class<? extends AbstractEntity> entityClass = (Class<? extends AbstractEntity>) Class.forName("de.starwit.ljprojectbuilder.entity." + entityName);
